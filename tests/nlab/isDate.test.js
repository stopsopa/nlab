...
it('isDate - new Date() -> true', async done => {
...
it('isDate - function () {} -> false', async done => {
...
it('isDate - true -> false', async done => {
...
it('isDate - false -> false', async done => {
...
it('isDate - NaN -> false', async done => {
...
it('isDate - undefined -> false', async done => {
...
it('isDate - no arg -> false', async done => {
...
it('isDate - string -> false', async done => {
...
it(`isDate - Symbol('test') -> false`, async done => {
