...
exports[`generateCurl all parts - body as a string 2`] = `"curl -d '{"key":"value"}' x"`;

exports[`generateCurl all parts - body not object, array or string 1`] = `"curl -d '{"key":"value"}' x"`;

exports[`generateCurl all parts - headers empty object 1`] = `"curl x"`;

exports[`generateCurl all parts - headers empty object 2`] = `"curl x"`;

exports[`generateCurl all parts - headers value 1`] = `"curl x"`;
