...
var etag = (function () {
  ...
  return function (n, i) {
    if (null == n) throw new TypeError("argument entity is required");
    var o =
        ((u = n),
        ("function" == typeof e && u instanceof e) ||
          (u &&
            "object" == typeof u &&
            "ctime" in u &&
            "[object Date]" === r.call(u.ctime) &&
            "mtime" in u &&
            "[object Date]" === r.call(u.mtime) &&
            "ino" in u &&
            "number" == typeof u.ino &&
            "size" in u &&
...
var staticServer = "controller___";
